    ...
    <>
        ...
        <div className='post-card'>
            ...
            <div className='post-info'>
                ...
                <h2>In the heart of a forgotten forest, where moonbeams dance upon dew-kissed leaves, lies an ancient stone circle. Within its moss-covered arches, ethereal beings gather under the silver glow of a crescent moon. Their luminous wings unfurl, casting delicate shadows on the weathered stones.</h2>
            ...
            <div className='commenter'>
              ...
              <div className='comment-section1'>
                ...
                <div className="comment">
                  ...
                  <p>This piece transports me to a realm where moonlight dances with magic.</p>
                </div>
                <div className="comment">
                  <h4>@DivulgerFan</h4>
                  <p>The way the colors blend feels like stardust settling on my soul. </p>
                </div>
                <div className="comment">
                  <h4>@Kreekcraft</h4>
                  <p>I can almost hear the celestial lute and taste the aurora elixir. Enchanting! </p>
                </div>
                <div className="comment">
