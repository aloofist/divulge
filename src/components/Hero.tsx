    ...
    <div className="main noselect nocursor">
      <div className="info nocursor">
        <h1 className="nocursor">
          ...
          <br />
          <span className="magic-words">Creations.</span>
        </h1>
        <p className="nocursor">
          Post and share anything you want! To your friends, family, random
          people online... anything and anyone you can think of.
        </p>
        <Button />
      </div>
